...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Edknonnect</span>
                </a>
              </div>
            </div>
            @if(session('success'))
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Copyright  Dashboard  Template by
          <a class="text-primary" href="http://www.edknonnect.com/" target="_blank">Edknonnect</a>.
        </p>
      </div>
    </div>
</body>
